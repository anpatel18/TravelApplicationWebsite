...
%>
<%
int oaircraft_id = Integer.parseInt(request.getParameter("oldAC_id"));
String oairline_id = request.getParameter("oldAL_id");
...
try{
	...
	cs = con.prepareCall("CALL TravelApplication.editAircraft("+aircraft_id+",'"+airline_id+"',"+oaircraft_id+",'"+oairline_id+"')");
	rs = cs.executeQuery();
	while(rs.next()){
		%>
		<tr>
