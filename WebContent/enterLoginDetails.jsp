...
<% 
    ...
    try{
    	...
    	rset = st.executeQuery("select * from userInformation where username='" + newUserId + "' or userPassword='" + newPwd + "'");
    	if(rset.next()){
    		if(rset.getString("username").equals(newUserId) && rset.getString("userPassword").equals(newPwd)){
    	...
    	{
			int rows;
	    	rows = innerst.executeUpdate("INSERT INTO TravelApplication.userInformation(username,userPassword) VALUES('"
	    							+ newUserId + "','" + newPwd + "')");
