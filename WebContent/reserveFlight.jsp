...
%>
	<form action="flightReserveFunction.jsp"> 
		<b>Flight ID:</b> <input type = "text" placeholder = "3 Letter ID" name = "flightID"> <br> <br>
		<b>Account Number:</b> <input type = "text"  name = "accountNum"> <br> <br>
		<b> Number of Tickets:</b> <input type="text"  name = "numTickets"> <br> <br>
		<b>Flight Type:</b> <br>
